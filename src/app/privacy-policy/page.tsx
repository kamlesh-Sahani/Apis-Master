  ...
  return (
    <div className="w-full flex justify-center items-center ">
      <div className="w-9/12 max-sm:w-full">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Apis Master.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Apis Master, accessible from{" "}
              <a
                href="https://www.apismaster.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.apismaster.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: kamleshbca2005@gmail.com</p>
          </li>
          <li>
            <p>
              ...
              <a
                ...
                target="_blank"
              >
                https://www.linkedin.com/in/kamlesh-sahani-692ab7247/
              </a>
            </p>
          </li>
        </ul>
